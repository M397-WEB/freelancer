...
add=(req,res)=>{
    ...
    if(!req.body.clientId){
     ...
     if(!req.body.technologyId){
        validationError.push("Technology Id is required.")
    }
...
getall = async (req, res) => {
    ...
    const totalCount = await post.countDocuments(req.body).exec();
...
module.exports={
    add,getall,getsingleData,deleteData,updateData,updateStatus
}