...
export default function UpdateTechnology(){
   ...
   const[prevImage,setPrevImage]=useState();
    ...
    useEffect(() =>{
       ...
       .then((res) =>{
        setTechnologyName(res.data.data.technologyName)
        setDescription(res.data.data.description)
       setPrevImage(res.data.data.techImg)
    ...
    const updateData = (e) =>{
        ...
        apiServices.updateTechnology(data,{headers:{authorization:token}})
        .then((res) =>{
            if(res.data.success){
  ...
  <div className="container-fluid py-5 mt-5" style={{display:display}}>
    <div className="container py-5">
      ...
      >
        ...
        <h1 className="mb-3">UPDATE TECHNOLOGY</h1>
        ...
        <div className="row g-5">
          ...
          <form onSubmit={updateData}>
              ...
              <div className="mb-4">
                ...
                <img src={BASE_IMAGE_URL+prevImage} style={{height:200,width:200,marginLeft:"30%"}}/>
